...
|---|---|---|---|
| EV_FUND_FLIP | funding_rate sign change between consecutive bars (>= 0.5 bp move) | 12 | 75 |
| EV_FUND_EXTREME | |funding_rate_zscore_30d| >= 2 (or |rate| >= 5 bp fallback) | 4 | 23 |
| EV_OI_SPIKE_UP | oi_pct_change_1h > +3% AND (oi_zscore_30d > 1 OR z insufficient) | 7 | 3 |
| EV_OI_FLUSH | oi_pct_change_1h < -3% | 3 | 0 |
| EV_VOL_BREAKOUT | range_pct >= rolling 99-pctile AND taker_quote_zscore_24 > 2 | 49 | 34 |
| EV_FUNDING_WINDOW_PRE | informational; minutes_to_next_settle <= 30 (first cross) | 84 | 175 |
| EV_PREMIUM_SPIKE | basis_zscore_24 >= +2 (mark - index spread spikes positive) | 244 | 131 |
| EV_PREMIUM_COMPRESSION | basis_zscore_24 <= -2 (mark - index spread spikes negative) | 194 | 71 |
