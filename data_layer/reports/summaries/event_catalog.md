...
|---|---|---|---|
| EV_FUND_FLIP | funding_rate sign change between consecutive bars (>= 0.5 bp move) | 5 | 12 |
| EV_FUND_EXTREME | |funding_rate_zscore_30d| >= 2 (or |rate| >= 5 bp fallback) | 0 | 4 |
| EV_OI_SPIKE_UP | oi_pct_change_1h > +3% AND (oi_zscore_30d > 1 OR z insufficient) | 1 | 0 |
| EV_OI_FLUSH | oi_pct_change_1h < -3% | 2 | 0 |
| EV_VOL_BREAKOUT | range_pct >= rolling 99-pctile AND taker_quote_zscore_24 > 2 | 8 | 3 |
| EV_FUNDING_WINDOW_PRE | informational; minutes_to_next_settle <= 30 (first cross) | 16 | 27 |
